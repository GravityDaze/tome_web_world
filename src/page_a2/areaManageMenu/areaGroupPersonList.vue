  ...
  <div class="dictionary_manage_style">
    ...
    <div class="my_scroll_x">
      ...
      <div id="addEditorForm">
        <el-dialog :title="$store.state.titleHeader" :visible.sync="$store.state.sceneryGroupPersonList2" width="35%"
                   align="left"
  ...
  export default {
    ...
    data() {
      return {
        ...
        mySearch: '',
        sign: 'sceneryGroupPersonList2',
        apiQuery2: '/a2guider/member/areaQueryTeamMember',
        apiTree: '/a2guider/touristTeam/areaQuery',
        apiSceneryProviderDropDown: '/a2guider/travelGency/dropDown',
        apiTouristLoadDropDown2: '/a2guider/tourLine/areaDropDown',//旅游线路下拉
        apiRailDropDown2: '/a2guider/electronicFence/areaDropDown',//电子围栏下拉
        apiGuideDropDown2: '/a2guider/member/areaQueryGuider',//导游下拉
        apiAdd2: '/a2guider/touristTeam/areaAdd',
        apiEditor2: '/a2guider/touristTeam/areaEdit',
        apiDel2: '/a2guider/touristTeam/areaDelete',
        apiCheckTouristGroupFn: '/a2guider/touristTeam/areaCheckName',
        apiCheckTouristGroupNumFn: '/a2guider/touristTeam/areaCheckUserName',
        apiGetEditorInfo2: '/a2guider/touristTeam/areaGet',
        apiLookMapInfo:'/a2guider/historyTrace/areaQueryMember',
        isShowEnabled: true,
    ...
    methods: {
      ...
      checkTouristGroupFn() {
        ...
        this.$axios(
          {
            method: 'post',
            url: this.apiCheckTouristGroupFn,
            data: {
              'TravelGencyID': this.ruleForm.TravelGencyID,
      ...
      getTouristLoadDropDown() {
        this.$axios(
          {
            method: 'get',
            url: this.apiTouristLoadDropDown2 + '?TravelGencyID=' + this.freeParam2,
            data: {}
          }
        ).then(res => {
          console.log('嚯嚯嚯：', res.data)
      ...
      getRailDropDown() {
        this.$axios(
          {
            method: 'get',
            url: this.apiRailDropDown2 + '?TravelGencyID=' + this.freeParam2,
            data: {}
          }
        ).then(res => {
          console.log('嚯嚯嚯：', res.data)
      ...
      getGuideDropDown() {
        this.$axios(
          {
            method: 'get',
            url: this.apiGuideDropDown2 + '?TravelGencyID=' + this.freeParam2,
            data: {}
          }
        ).then(res => {
          console.log('嚯嚯嚯：', res.data)
      ...
      addInfo() {
        ...
        this.$axios(
          ...
          if (res.data.resultStatus.resultCode === '0000') {
            this.$store.state.sceneryGroupPersonList2 = false
      ...
      chooseAreaGetListInfo(n) {
        ...
        if (n.Type == 2) {
          ...
          this.$axios(
            ...
            console.log('获取编辑信息接口返回的数据', res.data)
            if (res.data.resultStatus.resultCode === '0000') {
