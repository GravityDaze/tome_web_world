<template>
  <div>
    ...
    <div id="addEditorForm">
      <el-dialog :title="$store.state.titleHeader" :visible.sync="$store.state.roadLineInfo2" width="35%"
                 align="left"
          ...
          <el-row>
            ...
            <el-col :span="23">
              <el-form-item label="路线名称">
                <el-col v-if="$store.state.titleHeader == '新增'">
                  <el-input v-model="ruleForm.Name" placeholder="请输入线路名称" @blur="checkedRoadLineNameFn"></el-input>
                </el-col>

                <el-col v-if="$store.state.titleHeader == '编辑'">
                  <el-input v-model="ruleForm.Name" placeholder="请输入线路名称" :disabled="true"></el-input>
                </el-col>
            ...
            <el-col :span="23">
              <el-form-item label="省份">
                <el-col>
                  <el-select v-model="prov" class="change_select_style" size="small" placeholder="请选择省份">
                    <el-option
            ...
            <el-col :span="23">
              <el-form-item label="城市">
                <el-col>
                  <el-select v-model="city" class="change_select_style" size="small" placeholder="请选择城市">
                    <el-option
            ...
            <el-col :span="23">
              <el-form-item label="路线详情">
                <el-col>
                  <el-input v-model="ruleForm.Detail" placeholder="请输入线路名称"></el-input>
                </el-col>
            ...
            <el-col :span="23">
              <el-form-item label="路线类型">
                <el-col>
                  <el-select v-model="ruleForm.Type" class="change_select_style" size="small" placeholder="请选择状态">
                    <el-option
  ...
  export default {
    ...
    data() {
      return {
        ...
        sign: 'roadLineInfo2',
        apiQuery2: '/a2guider/tourLine/query',
        apiAdd2: '/a2guider/tourLine/add',
        apiEditor2: '/a2guider/tourLine/update',
        apiGetEditorInfo2: '',
        apiDel2: '/a2guider/tourLine/delete',
        apiRoadLineNameIsExist: '/a2guider/tourLine/isExits',//验证线路名称是否已经存在
        roadLineType: true,
        roadLineName: true,
        isAdd: true,
        isShowEnabled: true,
    ...
    methods: {
      ...
      //线路名称重复校验
      checkedRoadLineNameFn() {

        this.$axios(
          {
            method: 'post',
            url: this.apiRoadLineNameIsExist,
            data: {
              "Name": this.ruleForm.Name
            }
          }
        ).then(res => {
          console.log('线路名称校验结果', res.data)
          if (res.data.resultStatus.resultCode === '0000') {

            this.$message.success('此线路名称可用')
      ...
      //新增之前清空表单数据函数
      addBeforeClear() {
        this.$store.state.roadLineInfo2 = true
      ...
      addInfo() {
        ...
        this.$axios(
          ...
          if (res.data.resultStatus.resultCode === '0000') {
            this.$store.state.roadLineInfo2 = false
            this.getDefaultInfo()
        ...
        this.$axios(
          {
            ...
            url: this.apiQuery2,
            data: {
              "Type": this.$store.state.roadLineTypeParam2,
              "Name": this.$store.state.roadLineNameParam2,
