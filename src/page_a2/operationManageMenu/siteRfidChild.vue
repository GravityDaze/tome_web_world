<template>
  <div>
    ...
    <div id="addEditorForm">
      <el-dialog :title="$store.state.titleHeader" :visible.sync="$store.state.siteRfid2child" width="35%" align="left"
  ...
  export default {
    ...
    computed: {
      tableTitle: function () {
        return  [
          {
            prop: 'NO',
            label: this.$t('siteRfidInfo.no'),
            // width: '120',
            align: 'center'
          },
          {
            prop: 'Address',
            label: this.$t('siteRfidInfo.address'),
            // width: '120',
            align: 'center'
          },
          {
            prop: 'VisitCount',
            label: this.$t('siteRfidInfo.visitCount'),
            // width: '120',
            align: 'center'
          },
          {
            prop: 'TravelGencyName',
            label: this.$t('siteRfidInfo.sceneryProvider'),
            // width: '120',
            align: 'center'
          },
          {
            prop: 'ScenicName',
            label: this.$t('siteRfidInfo.scenerySpotName'),
            // width: '120',
            align: 'center'
          },
          {
            prop: 'distance',
            label:  this.$t('siteRfidInfo.visitRadius'),
            // width: '120',
            align: 'center'
          },
          {
            prop: 'CreateTime',
            label: this.$t('siteRfidInfo.createTime'),
            // width: '120',
            align: 'center'
          },
        ]
    ...
    methods: {
      ...
      addBeforeClear(){
        ...
        this.$store.state.siteRfid2child = true
      ...
      addInfo() {
        ...
        this.$axios(
          ...
          if (res.data.resultStatus.resultCode === '0000') {
            this.$store.state.siteRfid2child = false
            this.getDefaultInfo()
          }else {
            this.$message.warning(res.data.resultStatus.resultMessage)
          }
