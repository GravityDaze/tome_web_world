    ...
    computed: {
      tableTitle: function () {
        return [
          {
            prop: 'Content',
            label: this.$t('alertInfo.alert'),
            // width: '120',
            align: 'center'
          },
          {
            prop: 'CodeMachine',
            label: this.$t('alertInfo.codeMachine'),
            // width: '120',
            align: 'center'
          },
          ...
          {
            prop: 'MemberName',
            label: this.$t('alertInfo.memberNameTel'),
            // width: '120',
            align: 'center',
            formatter: function(row){
              return row.MemberName +'/'+ row.MemberPhone
          ...
          {
            prop: 'GuiderName',
            label: this.$t('alertInfo.guiderNameTel'),
            // width: '120',
            align: 'center',
            formatter: function(row){
              return row.GuiderName +'/'+ row.GuiderPhone
          ...
          {
            prop: 'TouristTeamName',
            label: this.$t('alertInfo.touristTeamName'),
            // width: '120',
            align: 'center'
          },
          {
            prop: 'CreateTime',
            label: this.$t('alertInfo.alertTime'),
            // width: '120',
            align: 'center'
          },
