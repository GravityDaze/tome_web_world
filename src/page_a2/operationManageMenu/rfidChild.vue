<template>
  <div>
    ...
    <div id="addEditorForm">
      <el-dialog :title="$store.state.titleHeader" :visible.sync="$store.state.rfid2child" width="35%" align="left"
          ...
          <el-row>
            ...
            <!--<el-col :span="23">-->
              <!--<el-form-item label="景区服务商">-->
                <!--<el-col>-->
                  <!--<el-select v-model="ruleForm.TravelGencyName" size="small" placeholder="请输入景区服务商"><el-option-->
  ...
  export default {
    ...
    data() {
      return {
        ...
        sign: 'rfid2child',
        apiQuery2: 'a2guider/RFID/query',
        apiSceneryProviderDropDown:'/a2guider/travelGency/dropDown',
        apiScenerySpotDropDown:'/a2guider/scenic/queryScenicList',
        apiAdd2:'/a2guider/RFID/add',
        apiEditor2:'/a2guider/RFID/update',
        apiDel2:'/a2guider/RFID/delete',
        // apiExport2:'/a2guider/RFID/export',
        apiImportUrl1:'/a2guider/RFID/templateDown',//A2导入数据前先下载表格
        apiImportUrl2:'/a2guider/RFID/importTerminal',//A2导入数据
        rfidSerialNum: true,
        createGroupTime2: true,
        isAdd: true,
        isImportDevice: false,
        isExportDevice: true,
        isImportParam: false,
        isShowEnabled: true,
        isHandle: true,
        ...
        tableData: [
          ...
          //   "ID": 2027,
          //   "NO": "65270002",
          //   "CreateTime": "2018-12-28 14:20:36",
          //   "Lng": 104.069568,
          //   "Lat": 30.614207,
          //   "TravelGencyID": 1245,
          //   "ScenicName": "童叟无欺",
    ...
    methods: {
      ...
      addBeforeClear(){
        ...
        this.$store.state.rfid2child = true
      ...
      addInfo() {
        ...
        this.$axios(
          ...
          if (res.data.resultStatus.resultCode === '0000') {
            this.$store.state.rfid2child = false
            this.getDefaultInfo()
          }else {
            this.$message.warning(res.data.resultStatus.resultMessage)
          }
